...
const clickSound = new Audio('../Music/Baraban.mp3');   // Sound for clicking a safe cell
const mineSound = new Audio('../Music/Baraban.mp3');    // Sound for hitting a mine
const cashOutSound = new Audio('../Music/Baraban.mp3'); // Sound for cashing out
...
function revealCell(row, col) {
    ...
    // CRITICAL FIX: Use 'row' and 'col' parameters, not undefined 'r' and 'c'
